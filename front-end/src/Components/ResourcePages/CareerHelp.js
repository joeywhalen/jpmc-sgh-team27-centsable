...
export default class CareerHelp extends Component {
  render() {
    return (
      <div className="container">
        ...
        <div className="main-text">
          <p> 
            Explore free tools, techniques and ideas to <b> inspire fun and creativity in your children's approach to programming.  </b> 
          </p>
          <p>
            <b>What you will learn</b> Overview of the best programming languages, platforms and environments to see kids progress with programming.
        ...
        <div className="main-text">
          <p> 
            <b> Skilling and Branding reflect a priority! </b> Individual marking is the cognizant and deliberate exertion to make and impact public view of a person by situating them as an expert in their industry, hoisting their validity, and separating themselves from the opposition, to eventually propel their profession, increment their circle of working environment.
          </p>
          <p>
